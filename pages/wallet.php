...
<body>
    ...
    <div class="hidden popup" id="sell-popup">
        ...
        <div class="popup-lista">
            ...
            <form class="ativo-card" action="../actions/sell.php" method="POST">
    ...
    <div class="hidden popup" id="edit-popup">
        ...
        <div class="popup-lista">
            ...
            <form class="ativo-card" action="../actions/edit.php" method="POST" data-valor-atual="<?= htmlspecialchars($ativo['valor_atual']) ?>">
...
<script>
    ...
    // Lê o valor atual de uma variável CSS de tema (ex: '--text', '--border')
    ...
    // Guarda as instâncias dos gráficos para poder recolorir ao trocar de tema
    ...
    function buildChartGridColor() {
        return getThemeColor('--border');
    }

    function applyChartTheme() {
        const textColor = buildChartTextColor();
        const gridColor = buildChartGridColor();

        if (lineChartInstance) {
            const s = lineChartInstance.options.scales;
            s.x.ticks.color = textColor;
            s.x.grid.color = gridColor;
            s.y.ticks.color = textColor;
            s.y.grid.color = gridColor;
        ...
        lineChartInstance = new Chart(ctxLine, {
            ...
            options: {
                ...
                scales: {
                    x: {
                        ticks: {
                            color: buildChartTextColor()
                        },
                        grid: {
                            color: buildChartGridColor()
                        }
                    },
    ...
    // Recolore os gráficos quando o tema muda (ex: alternado em outra aba)
    document.addEventListener("pingu-theme-change", applyChartTheme);
